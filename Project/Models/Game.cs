...
namespace ConsoleAdventure.Project.Models
{
  public class Game : IGame
  {
    ...
    public void Setup()
    {
      ...
      DeathRoom DeathArea2 = new DeathRoom("Death #2", "You try to carefully pick your path along to the door, and as you hop from one section to the next, the planks seem to be holding up.  You get to the door, and reach for the handle, but as soon as you stand still for more than a second, the planks beneath you start to give out.  You hold on to the handle as the planks fall away, but the handle is old and easily snaps off, you fall down into the pitch black pit below.");
